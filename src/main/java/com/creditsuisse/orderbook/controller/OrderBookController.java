...
public class OrderBookController {
    ...
    @ApiOperation(value = "openOrderBook", notes = "http://localhost:${server.port}/orderbook/open/{instrumentId}", response = ApiResponse.class)
    ...
    @ApiOperation(value = "closeOrderBook", notes = "http://localhost:${server.port}/orderbook/close/{instrumentId}", response = ApiResponse.class)
    ...
    @ApiOperation(value = "collectStats", notes = "http://localhost:${server.port}/orderbook/stats/{instrumentId}/{statsType}", response = ApiResponse.class)
    @ApiResponses({ @io.swagger.annotations.ApiResponse(code = 200, message = "success"),
